...
pub type imaxdiv_t = Struct_Unnamed9;
#[repr(C)]
#[derive(Copy)]
...
impl Union_Unnamed15 {
    pub unsafe fn heap(&mut self) -> *mut Struct_Unnamed16 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn ary(&mut self) -> *mut [VALUE; 3usize] {
...
impl Union_Unnamed19 {
    pub unsafe fn heap(&mut self) -> *mut Struct_Unnamed20 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn ary(&mut self) -> *mut [VALUE; 3usize] {
...
impl Union_Unnamed21 {
    pub unsafe fn big(&mut self) -> *mut Struct_Unnamed22 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn packed(&mut self) -> *mut Struct_Unnamed23 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
pub type st_update_callback_func =
    unsafe extern "C" fn(key: *mut st_data_t, value: *mut st_data_t,
                         arg: st_data_t, existing: ::libc::c_int)
        -> ::libc::c_int;
...
pub type rb_fdset_t = Struct_Unnamed24;
...
pub type rb_blocking_function_t =
    unsafe extern "C" fn(arg1: *mut ::libc::c_void) -> VALUE;
